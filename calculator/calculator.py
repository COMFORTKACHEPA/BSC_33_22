...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pofloat = QtWidgets.QPushButton(Form)
        self.pofloat.setGeometry(QtCore.QRect(120, 330, 93, 41))
        self.pofloat.setObjectName("pofloat")
    ...
    def retranslateUi(self, Form):
        ...
        self.pofloat.setText(_translate("Form", "."))
        self.pofloat.clicked.connect(self.valpofloat)
...
# number  set after clicked
    def val1(self):
         ...
         val = self.one.text()
         vall = self.lineEdit.text()
         self.lineEdit.setText(vall+val)
...
# clear set after click
    ...
    def clea(self):
            c = len(self.clear.text().strip())-2
            value = self.lineEdit.text()[:c]
            self.lineEdit.setText(value)


#answer implement function
    def valanswe(self):
       answebox = self.lineEdit.text().strip()
       if '+' in answebox:
           left,rigt = answebox.split("+")
           answeboxx = float(left) + float(rigt)
       elif '-' in answebox:
           left,rigt = answebox.split("-")
           answeboxx = float(left) - float(rigt)
           ...
           left,rigt = answebox.split("/")
           answeboxx = float(left) / float(rigt)
       self.lineEdit.setText(f"{answebox} = {answeboxx}")
...
if __name__ == "__main__":
    ...
    # run install pyinstaller --onefile --windowed --icon=your_icon.ico your_script.py
